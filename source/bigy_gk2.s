...
patch:
        ...
        ifeq old_mmu
        move.w  #30-1+2,-$2a(a0)
        move.w  #240+16+4,d0    ;new y size of screen
        endc
        move.w  d0,-4(a0)
        move.w  d0,-$02b2(a0)
intout  equ *+2
...
copyright:
        dc.b 27,'Y',32+23,32,'Big Y by Christian Limpach installed.',13,10
        dc.b 'New screen memory in use.      +16 lines',27,'Y',13,10,0
